...
def alumno():
    ...
    return render_template("alumnos/listaAlum.html",form=create_form,alumnos=alumnos)
...
def detalles():
    ...
    if request.method=='GET':
        ...
        cursos=alum1.cursos
    return render_template('alumnos/detalles.html', id=id,nombre=nombre,apellidos=apellidos,
                           email=email,telefono=telefono,cursos=cursos)
